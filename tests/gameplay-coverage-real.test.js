...
// Importar GameplayEngine real
let GameplayEngine;
try {
    GameplayEngine = require('../client/GameplayEngine.js').default || window.GameplayEngine;
} catch (error) {
    // Se não conseguir importar, criar um mock que simula o real
    GameplayEngine = class GameplayEngine {
        constructor() {
            this.mobs = [];
            this.player = null;
...
describe('GameplayEngine - Mob AI System', () => {
    ...
    describe('AI State Transitions', () => {
        ...
        it('should transition to fleeing when HP is low', () => {
            ...
            mob.hp = 5;
            mob.maxHp = 20;
            mob.lastDecision = Date.now() - 2000; // Forçar decisão
        ...
        it('should transition to attacking when in range', () => {
            ...
            player.y = mob.y + 20;
            mob.lastDecision = Date.now() - 2000; // Forçar decisão
            mob.lastAttack = Date.now() - 3000; // Forçar ataque
    ...
    describe('Mob Attack System', () => {
        ...
        it('should keep player in bounds', () => {
            ...
            // Player deve estar dentro dos limites (simulado)
    ...
    describe('Game Loop Integration', () => {
        it('should start game loop correctly', () => {
            ...
            const success = engine.startGame(characterData);
